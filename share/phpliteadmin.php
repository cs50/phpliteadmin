...
echo '<script>';
echo 'function _toggleAutoIncrement(i) {';
echo '    const typesMenu = document.querySelector(`#i${i}_type`);';
echo '    const selectedOption = typesMenu.options[typesMenu.selectedIndex].value;';
...
echo '    }';
echo '    else {';
echo '        autoIncrement.disabled = true;';
echo '        autoIncrement.checked = false;';
echo '    }';
echo '}';
echo 'const newMenu = `';
echo '  <option disabled selected hidden value=""></option>';
echo '  <optgroup label="BLOB">';
echo '    <option value="bytea">bytea</option>';
echo '  </optgroup>';
echo '  <optgroup label="INTEGER">';
echo '    <option value="smallint">smallint</option>';
echo '    <option value="integer">integer</option>';
echo '    <option value="bigint">bigint</option>';
echo '  </optgroup>';
echo '  <optgroup label="NUMERIC">';
echo '    <option value="boolean">boolean</option>';
echo '    <option value="date">date</option>';
echo '    <option value="datetime">datetime</option>';
echo '    <option value="numeric">numeric(precision, scale)</option>';
echo '    <option value="time">time</option>';
echo '    <option value="timestamp">timestamp</option>';
echo '  </optgroup>';
echo '  <optgroup label="REAL">';
echo '    <option value="real">real</option>';
echo '    <option value="double precision">double precision</option>';
echo '  </optgroup>';
echo '  <optgroup label="TEXT">';
echo '    <option value="char">char(n)</option>';
echo '    <option value="varchar">varchar(n)</option>';
echo '    <option value="text">text</option>';
echo '  </optgroup>';
echo '`;';
echo 'const typesMenus = document.querySelectorAll("select[name$=_type]");';
echo 'const form = typesMenus.length && typesMenus[0].closest("form");';
echo 'const createTable = form && form.action.indexOf("table_create") > -1;';
echo 'if (form) {';
echo '    form.onsubmit = () => {';
echo '        const invalid = [...typesMenus].some(menu => {';
echo '            if (menu.options[menu.selectedIndex].value.startsWith("numeric")) {';
echo '                if (!/^$|^\d*[1-9]\d*(,\s?\d*[1-9]\d*)?$/.test(menu.nextSibling.value)) {';
echo '                    alert("Expected positive precision, scale");';
echo '                    return true;';
echo '                }';
echo '                menu.options[menu.selectedIndex].value = menu.nextSibling.value ? `numeric(${menu.nextSibling.value})` : "numeric";';
echo '            }';
echo '            else if (menu.options[menu.selectedIndex].value.indexOf("char") > -1) {';
echo '                if (!/^\d*[1-9]\d*$/.test(menu.nextSibling.value)) {';
echo '                    alert("Expected positive length n");';
echo '                    return true;';
echo '                }';
echo '                menu.options[menu.selectedIndex].value = `${menu.options[menu.selectedIndex].value.replace(/\(.*\)$/, "")}(${menu.nextSibling.value})`;';
echo '            }';
echo '        });';
echo '        if (invalid)';
echo '            return false;';
...
echo '    };';
echo '}';
echo 'document.querySelectorAll("input[name$=_primarykey]").forEach(checkbox => {';
echo '    checkbox.addEventListener("change", e => {';
echo '        _toggleAutoIncrement(e.target.name.replace(/_primarykey$/, ""));';
echo '    });';
echo '});';
echo 'typesMenus.forEach(menu => {';
echo '    const input = document.createElement("input");';
echo '    input.type = "text";';
echo '    input.style.width = "164px";';
echo '    input.disabled = true;';
echo '    menu.parentNode.insertBefore(input, menu.nextSibiling);';
echo '    menu.addEventListener("change", () => {';
echo '        const selectedOption = menu.options[menu.selectedIndex].value;';
echo '        const matches = /\((.*)\)$/.exec(selectedOption);';
echo '        if (selectedOption.startsWith("numeric")) {';
echo '            input.placeholder = "precision, scale";';
echo '            input.disabled = false;';
echo '            if (matches && matches[1]) {';
echo '                input.value = matches[1];';
echo '            }';
echo '        }';
echo '        else if (selectedOption.startsWith("char") || selectedOption.startsWith("varchar")) {';
echo '            input.placeholder = "n";';
echo '            input.disabled = false;';
echo '            if (matches && matches[1]) {';
echo '                input.value = matches[1];';
echo '            }';
...
echo '    });';
echo '    if (createTable) {';
echo '        menu.addEventListener("change", e => {';
echo '            _toggleAutoIncrement(e.target.name.replace(/_type$/, ""));';
echo '        });';
echo '        return menu.innerHTML = newMenu;';
echo '    }';
echo '	const selectedOption = menu.options[menu.selectedIndex];';
echo '    const charMatches = /^char(\((\d*[1-9]\d*)\))?$/.exec(selectedOption.value);';
echo '    const varcharMatches = /^varchar(\((\d*[1-9]\d*)\))?/.exec(selectedOption.value);';
echo '    const numericMatches = /^numeric(\((\d*[1-9]\d*(, \d*[1-9]\d*)?)\))?/.exec(selectedOption.value);';
echo '    menu.innerHTML = newMenu;';
echo '	const selected = [...menu.querySelectorAll("option")].some(((option, i) => {';
echo '        if (option.value.startsWith("char") && charMatches) {';
echo '            option.value = selectedOption.value;';
echo '            menu.nextSibling.placeholder = "n";';
echo '            menu.nextSibling.disabled = false;';
echo '            menu.selectedIndex = i;';
echo '            if (charMatches[2])';
echo '                menu.nextSibling.value = charMatches[2];';
echo '            return true;';
echo '        }';
echo '        else if (option.value.startsWith("varchar") && varcharMatches) {';
echo '            option.value = selectedOption.value;';
echo '            menu.nextSibling.placeholder = "n";';
echo '            menu.selectedIndex = i;';
echo '            menu.nextSibling.disabled = false;';
echo '            if (varcharMatches[2])';
echo '                menu.nextSibling.value = varcharMatches[2];';
echo '            return true;';
echo '        }';
echo '        else if (option.value.startsWith("numeric") && numericMatches) {';
echo '            option.value = selectedOption.value;';
echo '            menu.nextSibling.placeholder = "precision, scale";';
echo '            menu.nextSibling.disabled = false;';
echo '            menu.selectedIndex = i;';
echo '            if (numericMatches[2])';
echo '                menu.nextSibling.value = numericMatches[2];';
echo '            return true;';
echo '        }';
echo '        else if (option.value == selectedOption.value)';
echo '		{';
echo '            input.placegolder = "";';
echo '            input.value = "";';
echo '            input.disabled = true;';
echo '			menu.selectedIndex = i;';
echo '			return true;';
...
echo '	}));';
echo '	if (!selected) {';
echo '		menu.innerHTML = `${selectedOption.outerHTML} ${menu.innerHTML}`;';
